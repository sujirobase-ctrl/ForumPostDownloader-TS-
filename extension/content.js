...
(function () {
        ...
        h.elements('.message-attribution-opposite').forEach(post => {
            ...
            const postDownloadCallbacks = {
                onComplete: (total, completed) => {
                    // Post reaction disabled in extension version
                },
            };
    ...
    // Run init: if DOM already loaded (document_end/idle), run immediately; otherwise wait
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', _xfpdInit);
    } else {
        _xfpdInit();
    }
})();
